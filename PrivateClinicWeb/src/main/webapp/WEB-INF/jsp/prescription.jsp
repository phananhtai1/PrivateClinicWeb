...
<a href="<c:url value="/employee/addEmployee" />" class="btn btn-success">Thêm nhân viên</a>
    ...
    <tbody>
        <c:forEach items="${employee}" var = "em">
            <tr id="employee${em.id}">
                ...
                <td>${em.address}</td>
                <td>${em.phone}</td>
                <td class="text-center"> <a href="<c:url value="/employee/updateEmployee" />/?employeeId=${em.id}"  class="btn btn-primary">Cập Nhật</a>
