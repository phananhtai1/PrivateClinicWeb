...
<a href="<c:url value="/appointment/addAppointment" />" class="btn btn-success">Đặt lịch hẹn</a> 
    ...
    <tbody>
        <c:forEach items="${appointment}" var = "ap">
            <tr id="appointment${ap[0]}">
                ...
                <td>${ap[2]}</td>
                <td>${ap[3]}</td>
                <td class="text-center"> <a href="<c:url value="/appointment/updateAppointment" />/?appointmentId=${ap[0]}"  class="btn btn-primary">Cập Nhật</a>
