...
<h1 class="text-center text-success m-3">Cập nhật Thông Tin Bệnh Nhân</h1>  
<c:url value="/patient/updatePatient/update" var="action" />
<form:form method="post"  action="${action}" modelAttribute="updatePatient">
    ...
    <div>
        <form:hidden path="id" />
        <input type="submit" class="btn btn-success" value="<spring:message code="updatePatient.submit" />" />
    </div>
</form:form>
