...
<a href="<c:url value="/medicine/addMedi" />" class="btn btn-success">Thêm thuốc mới</a> 
    ...
    <tbody>
        <c:forEach items="${medicine}" var = "medi">
            <tr id="medicine${medi.id}">
                ...
                <td class="text-center"> <a href="<c:url value="/medicine/updateMedi" />/?mediId=${medi.id}"  class="btn btn-primary">Cập Nhật</a>
