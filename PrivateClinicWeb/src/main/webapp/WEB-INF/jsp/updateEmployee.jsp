...
<h1 class="text-center text-success m-3">Cập nhật Thông Tin Nhân Viên</h1>  
<c:url value="/employee/updateEmployee/update" var="action" />
<form:form method="post"  action="${action}" modelAttribute="updateEmployee">
    ...
    <div>
        <form:hidden path="id" />
        <input type="submit" class="btn btn-success" value="<spring:message code="updateEmployee.submit" />" />
    </div>
</form:form>
