...
<c:url value="/admin/medicalForm/addMedicalForm" var="action" />
<form:form method="post"  action="${action}" modelAttribute="addMedicalForm">
    ...
    <div class="form-group">
        ...
        <form:input cssClass="form-control" path="symptom" placeholder="Nhập triệu chứng"/>
        <form:errors path="symptom" cssClass="text-danger" />
    </div>
    <div class="form-group">
        <label><spring:message code="mf.diagnostic" /></label>
        <form:input cssClass="form-control" path="diagnostic" placeholder="Nhập chuẩn đoán" />
        <form:errors path="diagnostic" cssClass="text-danger" />
    </div>
    <div class="form-group">
        <label><spring:message code="mf.examinationDate" /></label>
        <form:input cssClass="form-control" path="examinationDate" type="date"/>
        <form:errors path="examinationDate" cssClass="text-danger" />
    </div>
    <div>
        <input type="submit" class="btn btn-success" value="<spring:message code="addMf.submit" />" />
    </div>
</form:form>
